...
from knowledge_bert.modeling_exp1 import BertForSequenceClassification
...
def load_ent_emb_static():
    ...
    #with open('../../data/load_data_test/e1_e2_list_2D_Tensor.pkl', 'rb') as f:
        ent_neighbor = pickle.load(f)

    with open('../../data/load_data_n/e1_r_list_2D_Tensor.pkl', 'rb') as f:
    #with open('../../data/load_data_test/e1_r_list_2D_Tensor.pkl', 'rb') as f:
        ent_r = pickle.load(f)

    with open('../../data/load_data_n/e1_outORin_list_2D_Tensor.pkl', 'rb') as f:
    #with open('../../data/load_data_test/e1_outORin_list_2D_Tensor.pkl', 'rb') as f:
...
def load_knowledge():
    ...
    #with open("../../data/kg_embed/entity2vec.del", 'r') as fin:
        for line in fin:
    ...
    #with open("../../data/kg_embed/relation2vec.del", 'r') as fin:
        for line in fin:
            vec = line.strip().split('\t')
            vec = [float(x) for x in vec]
            vecs.append(vec)
