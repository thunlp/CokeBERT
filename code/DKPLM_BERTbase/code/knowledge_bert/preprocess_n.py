...
with open("../../../../data/kg_embed/train2id.txt") as fp:
...
with open('../../../../data/load_data_n/e1_e2_list_2D_Tensor.pkl', 'wb') as f:
    pickle.dump(e1_e2_list_2D_Tensor, f, protocol=pickle.HIGHEST_PROTOCOL)
with open('../../../../data/load_data_n/e1_r_list_2D_Tensor.pkl', 'wb') as f:
    pickle.dump(e1_r_list_2D_Tensor, f, protocol=pickle.HIGHEST_PROTOCOL)
with open('../../../../data/load_data_n/e1_outORin_list_2D_Tensor.pkl', 'wb') as f:
    pickle.dump(e1_outORin_list_2D_Tensor, f, protocol=pickle.HIGHEST_PROTOCOL)
...
#load
with open('../../../../data/load_data/e1_e2_list_2D_Tensor.pkl', 'rb') as f:
    e1_e2_list_2D_Tensor = pickle.load(f)
with open('../../../../data/load_data/e1_r_list_2D_Tensor.pkl', 'rb') as f:
    e1_r_list_2D_Tensor = pickle.load(f)
with open('../../../../data/load_data/e1_outORin_list_2D_Tensor.pkl', 'rb') as f:
...
with open('../../../../data/load_data/e_.pkl', 'wb') as f:
