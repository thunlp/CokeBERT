...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, encoder_hidden_states=None, encoder_attention_mask=None):
        #print(attention_mask.shape) #[batch_size,1,1,128]
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
        ...
        if attention_mask.dim() == 3: #No used
        ...
        #print(attention_mask) #[32,128]
        #print(attention_mask.shape) #[32,1,1,128]
        ...
        #print(encoder_attention_mask.shape) #[32,128]
        if encoder_attention_mask.dim() == 3:
            encoder_extended_attention_mask = encoder_attention_mask[:, None, :, :]
        if encoder_attention_mask.dim() == 2:
            encoder_extended_attention_mask = encoder_attention_mask[:, None, None, :]
        #print(encoder_extended_attention_mask.shape) #[32,1,1,128]
        ...
        #print(position_ids) #None
        #print(token_type_ids.shape) #[batch_size,128]
        #print(inputs_embeds) #None
        embedding_output = self.embeddings(input_ids=input_ids, position_ids=position_ids, token_type_ids=token_type_ids, inputs_embeds=inputs_embeds)
        #self.encoder output: last-layer hidden state, (all hidden states), (all attentions)
        ...
        #print(sequence_output.shape) #[batch_size,128,768]
