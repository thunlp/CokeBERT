...
class BertForPreTraining(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
        ...
        #print(candidate)
        #print(candidate.shape) #test [10,100]
        #exit()
        ...
        #print(pooled_output.shape) #[2, 768] --> CLS
        #exit()
        ...
        if masked_lm_labels is not None and next_sentence_label is not None:
            ...
            #print("=======================")
            #print(prediction_scores_ent.view(-1,candidate.shape[0]))
            #print(prediction_scores_ent.view(-1,candidate.shape[0]).shape)
            #print("-------")
