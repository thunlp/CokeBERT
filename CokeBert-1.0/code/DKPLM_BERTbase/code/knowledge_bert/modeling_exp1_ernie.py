...
class BertIntermediate(nn.Module):
    ...
    def forward(self, hidden_states, hidden_states_ent, _type=None):
        ...
        if _type == "mix":
            return hidden_states_, self.dense_ent
...
class BertLayerMix(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, hidden_states_ent, attention_mask_ent, ent_mask):
        ...
        #intermediate_output = self.intermediate(attention_output, attention_output_ent, mix)
        layer_output, dense_ent = self.intermediate(attention_output, attention_output_ent, "mix")
        #layer_output, layer_output_ent = self.output(intermediate_output, attention_output, attention_output_ent, "mix")
        # layer_output_ent = layer_output_ent * ent_mask
        #return layer_output, layer_output_ent
        return layer_output, dense_ent
        ...
        if mode=="encoder1":
            ...
            for i_th_layer,layer_module in enumerate(self.layer):
                ...
                if self.layer_types[i_th_layer] == "mix":
                    ...
                    hidden_states, dense_ent = layer_module(hidden_states, attention_mask, hidden_states_ent, attention_mask_ent, ent_mask)
                    return hidden_states, dense_ent
            ...
            for i_th_layer,layer_module in enumerate(self.layer[5:]):
                ...
                # Attention: hidden_states and hidden_states_ent
                # return ranking
...
class Word_Graph_Attention(nn.Module):
    ...
    def forward(self, input_ent, q, k, v, mode, ent_linear, ent_n):

        q = q[:,0,:] #all input: 0, !=0
        return self.self_attention(q,k,v,"entity",ent_linear, ent_n)
...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, output_all_encoded_layers=True, k=None, v=None, candidate=None, k_cand=None, v_cand=None, cand_pos_tensor=None, mode=None, ent_n=None):
        ...
        hidden_states, dense_ent = self.encoder(embedding_output, all_encoder_layers, extended_attention_mask, input_ent, extended_ent_mask, ent_mask, i_th_layer=0,output_all_encoded_layers=output_all_encoded_layers, mode="encoder1")
        ...
        if len(input_ent[input_ent!=0]) == 0:
            ...
            #hidden_states_ent = self.word_graph_attention(input_ent, hidden_states, k, v, "entity")
            ids = self.word_graph_attention(input_ent, hidden_states, k, v, "entity", dense_ent, ent_n)
...
class BertForEntityTyping(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, labels=None, k=None, v=None):
        ...
        ids = self.bert(input_ids, token_type_ids, attention_mask, input_ent.long(), ent_mask, output_all_encoded_layers=False, k=v, v=v, mode="typing")
...
class BertForSequenceClassification(PreTrainedBertModel):
    ...
    def forward(self, input_ids=None, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, labels=None, k=None, v=None, ent_n=None):
        ...
        ids = self.bert(input_ids, token_type_ids, attention_mask, input_ent.long(), ent_mask, output_all_encoded_layers=False, k=k, v=v, candidate=None, k_cand=None, v_cand=None, cand_pos_tensor=None, mode="classfication", ent_n=ent_n)
