...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, output_all_encoded_layers=True, k=None, v=None, candidate=None, k_cand=None, v_cand=None, cand_pos_tensor=None, task_mode=None):
        ...
        #att
        _, encoded_layers_att, _ = self.encoder(hidden_states, all_encoder_layers, extended_attention_mask, hidden_states_ent_att, extended_ent_mask, ent_mask, i_th_layer=i_th_layer, output_all_encoded_layers=output_all_encoded_layers, mode="encoder2")

        #transE
        _, encoded_layers_transE, _ = self.encoder(hidden_states, all_encoder_layers, extended_attention_mask, hidden_states_ent_transE, extended_ent_mask, ent_mask, i_th_layer=i_th_layer, output_all_encoded_layers=output_all_encoded_layers, mode="encoder2")
...
class BertForPreTraining(PreTrainedBertModel):
    ...
    def __init__(self, config, args):
        ...
        self.cls_att = BertPreTrainingHeads(config, self.bert.embeddings.word_embeddings.weight)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
        ...
        #Att
        prediction_scores, seq_relationship_score, prediction_scores_ent = self.cls_att(sequence_output, pooled_output, candidate_emb)
        #TransE
