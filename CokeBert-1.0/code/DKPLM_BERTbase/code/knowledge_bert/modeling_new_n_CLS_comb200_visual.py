...
class BertLayerMix(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, hidden_states_ent, attention_mask_ent, ent_mask):
        ...
        try:
            ...
            attention_output_ent = torch.zeros(1,256,200).type(hidden_states_ent.type())
...
class Word_Graph_Attention(nn.Module):
    ...
    def forward(self, input_ent, q, k_1, v_1, k_2, v_2, mode):
        ...
        if mode == "entity":
            q = q[:,0,:] #all input: 0, !=0
            if v_1.shape[1] == 0 or v_2.shape[1]==0:
                #print(v_1.type())
                print("All zeros!!!!")
                return torch.zeros(1,2,200).type(v_1.type())

            combined = self.self_attention(q, k_1, v_1, k_2, v_2, mode)
...
class BertForEntityTyping(PreTrainedBertModel):
    ...
    #def forward(self, input_ids, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, labels=None, k=None, v=None):
        ...
        _, pooled_output, hidden_states_6th_original = self.bert(input_ids, token_type_ids, attention_mask, input_ent.long(), ent_mask, output_all_encoded_layers=False, k_1=k_1, v_1=v_1, k_2=k_2, v_2=v_2, candidate=None, k_cand_1=None, v_cand_1=None, k_cand_2=None, v_cand_2=None, cand_pos_tensor=None, mode="typing")
...
class BertForSequenceClassification(PreTrainedBertModel):
    ...
    def forward(self, input_ids=None, token_type_ids=None, attention_mask=None, input_ent=None, ent_mask=None, labels=None, k_1=None, v_1=None, k_2=None, v_2=None):
        ...
        _, pooled_output, hidden_states_6th_original = self.bert(input_ids, token_type_ids, attention_mask, input_ent.long(), ent_mask, output_all_encoded_layers=False, k_1=k_1, v_1=v_1, k_2=k_2, v_2=v_2, candidate=None, k_cand_1=None, v_cand_1=None, k_cand_2=None, v_cand_2=None, cand_pos_tensor=None, mode="classfication")
